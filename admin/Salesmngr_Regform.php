...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Sales Manager Registration</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
          <li class="breadcrumb-item">Forms</li>
          <li class="breadcrumb-item">Register Sales Manager</li>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="../includes/code.php" method="post" class="row g-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="Agent_Firstname" class="form-control" id="Cp_Firstname">
                </div>
                <div class="col-md-6">
                  <label for="inputPassword5" class="form-label">Lastname</label>
                  <input type="text" name="Agent_Lastname" class="form-control" id="Cp_Lastname">
                </div>
				  
				      <div class="col-md-2">
                  <label for="inputCity" class="form-label">Age</label>
                  <input type="text" name="Agent_Age" class="form-control" id="Cp_Age">
                </div>
                <div class="col-md-4">
                  <label for="inputState" class="form-label">Age Bracket</label>
                  <select id="Cp_Age_bracket" name="Agent_Age_bracket" class="form-select">
                ...
                <div class="col-md-2">
                  ...
                  <select id="Cp_Gender" name="Agent_Gender" class="form-select">
                    <option selected>Choose...</option>
                    <option>Male</option>
                  ...
                  <select id="Cp_Marital_status" name="Agent_Marital_status" class="form-select">
                    <option selected>Choose...</option>
                ...
                <div class="col-4">
                  ...
                  <input type="text" class="form-control" name="Agent_mobileno" id="Cp_mobileno" placeholder="">
                </div>  
				  
				  <div class="col-4">
                  <label for="inputAddress5" class="form-label">Email</label>
                  <input type="text" class="form-control" name="Agent_Email" id="Cp_Email" placeholder="Sample@gmail.com">
                </div> 
            ...
            <option selected>Choose...</option>
              ...
              <input type="text" name="Agent_Region" class="form-control" id="Cp_Region" placeholder="">
                  ...
                  <input type="text" name="Agent_Province" class="form-control" id="Cp_Province" placeholder="">
                </div> 
